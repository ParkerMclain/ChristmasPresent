...
class ViewControllerQ5: UIViewController {
    ...
    @IBAction func buttonA(_ sender: UIButton) {
       ...
       score = score + 1
        ...
        let nextViewController = storyBoard.instantiateViewController(withIdentifier: "ViewControllerQ3") as! ViewControllerQ3
